...
test-db-security:
	...
	HEALTH_DB_TESTS=1 go test ./internal/storage -run '^(TestVerifySchemaContractContextHonorsCancellation|TestEnsureSchemaContractContextHonorsCancellation|TestVerifySchemaContractRejectsViewSpoofingRequiredTable|TestVerifySchemaContractRejectsWrongIndexDefinition|TestVerifySchemaContractRejectsWrongPartialIndexLiteralCase|TestEnsureTenantIdentityUpgradesLegacyMarker|TestRestoreTenantIdentityMarkerContractRetriesOlderVersion|TestEnsureTenantIdentityRejectsIdentityMismatch|TestEnsureTenantIdentityRejectsNonLegacyContractMismatch)$$' -count=1 -timeout=120s
