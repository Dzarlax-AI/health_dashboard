...
var en = LangStrings{
	...
	"energy_reason_autonomic_prodrome_moderate": "Repeated autonomic strain is present, so today's recommendation is capped at active recovery.",
	...
	"tg_morning_metrics":   "Key metrics",
	"tg_morning_why":       "Why",
