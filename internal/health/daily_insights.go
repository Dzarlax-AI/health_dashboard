...
func localizedNarrativeMeaning(locale, id string) string {
	translations := map[string]map[string]string{
		"en": {
			...
			"sleep_pattern_not_single_night": "A run of shorter nights says more than one off night.",
			"sleep_wind_down_bridge":         "The existing evening action follows the recent run of shorter nights.",
			"recovery_pacing_not_verdict":    "Lower readiness leaves less margin around today.",
			"energy_pacing_today":            "Lower energy leaves less to draw on today.",
		},
		"ru": {
			...
			"sleep_pattern_not_single_night": "Несколько более коротких ночей подряд значат больше, чем одна такая ночь.",
			"sleep_wind_down_bridge":         "Вечернее действие связано с недавней серией более коротких ночей.",
			"recovery_pacing_not_verdict":    "Более низкая готовность оставляет сегодня меньше запаса.",
			"energy_pacing_today":            "При более низком запасе энергии сегодня остаётся меньше ресурса.",
		},
		"sr": {
			...
			"sleep_pattern_not_single_night": "Niz kraćih noći govori više od jedne izdvojene noći.",
			"sleep_wind_down_bridge":         "Večernja radnja prati nedavni niz kraćih noći.",
			"recovery_pacing_not_verdict":    "Niža spremnost danas ostavlja manje rezerve.",
			"energy_pacing_today":            "Niža energija danas ostavlja manje na raspolaganju.",
		},
	}
