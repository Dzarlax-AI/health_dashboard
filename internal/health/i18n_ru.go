...
var ru = LangStrings{
	...
	"energy_reason_illness_suspicion_moderate":  "Есть респираторные/вегетативные сигналы, похожие на болезнь, поэтому рекомендация ограничена активным восстановлением.",
	"energy_reason_illness_suspicion_high":      "Несколько сигналов похожи на болезнь, поэтому рекомендация ограничена отдыхом.",
	"energy_reason_autonomic_prodrome_moderate": "Несколько дней видна повышенная автономная нагрузка, поэтому рекомендация ограничена активным восстановлением.",
	...
	"tg_morning_metrics":   "Главные показатели",
