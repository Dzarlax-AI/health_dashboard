...
var categories = []struct {
	...
	{"cat_heart", "#e11d48", "heart", []string{"heart_rate", "resting_heart_rate", "walking_heart_rate_average", "heart_rate_variability", "blood_oxygen_saturation", "respiratory_rate", "blood_pressure_systolic", "blood_pressure_diastolic", "heart_rate_recovery", "wrist_temperature", "breathing_disturbances"}},
	{"cat_activity", "#059669", "activity", []string{"step_count", "walking_running_distance", "active_energy", "basal_energy_burned", "apple_exercise_time", "apple_stand_time", "apple_stand_hour", "physical_effort", "flights_climbed", "stair_ascent_speed", "stair_descent_speed", "distance_cycling", "distance_swimming", "swimming_stroke_count", "mindful_minutes"}},
	...
	{"cat_sleep", "#7c3aed", "sleep", []string{"sleep_total", "night_sleep_total", "nap_total", "sleep_deep", "sleep_rem", "sleep_core", "sleep_unspecified", "sleep_awake"}},
