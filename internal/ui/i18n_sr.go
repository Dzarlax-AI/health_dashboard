...
var translationsSr = map[string]string{
	...
	"readiness_serving_desc_low_coverage":                         "Score je prikazan sa niskom sigurnošću jer su pokrivenost ili kvalitet slabi.",
	...
	"readiness_serving_note_low_coverage":                         "Niska sigurnost: pokrivenost je tanka.",
	"readiness_serving_note_capped":                               "Prikazani score je sigurnosno korigovan.",
	"readiness_serving_reason_missing_same_day_evidence":          "Današnji HRV, puls u miru ili san nisu kompletni.",
	"readiness_serving_reason_hrv_provisional":                    "HRV danas ima premalo uzoraka.",
	"readiness_serving_reason_hrv_sparse":                         "HRV pokrivenost je danas retka.",
	"readiness_serving_reason_rhr_missing_overnight_hr_available": "Puls u miru nedostaje; noćni puls je dostupan samo kao kontekst.",
	"readiness_serving_reason_sleep_quality_low":                  "Pokrivenost kvaliteta sna je danas slaba.",
	"readiness_serving_reason_illness_suspicion_moderate":         "Prisutni su signali nalik bolesti, zato je score oprezan.",
	"readiness_serving_reason_illness_suspicion_high":             "Više signala liči na bolest, zato je score oprezan.",
	"readiness_serving_reason_stress_headline":                    "Signali stresa su dovoljno jaki da prikazani score ostane oprezan.",
	"readiness_serving_reason_sleep_debt_headline":                "Signali manjka sna su dovoljno jaki da prikazani score ostane oprezan.",
