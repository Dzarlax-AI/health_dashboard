...
var translationsSr = map[string]string{
	...
	"illness_signal_respiratory_rate":          "Respiratorni ritam",
	"illness_signal_blood_oxygen_saturation":   "Kiseonik u krvi",
	"illness_signal_resting_heart_rate":        "Puls u miru",
	"illness_signal_heart_rate_variability":    "HRV",
	"illness_signal_wrist_temperature":         "Temperatura zgloba",
	...
	"admin_checkin_coverage_desc":               "Kalendarski SLA posle datuma uključivanja, plus poslednja jutarnja Telegram pitanja i latencija odgovora.",
	"admin_checkin_enabled_since":               "Uključeno od",
	"admin_checkin_calendar_sla":                "Kalendarski SLA",
	"admin_checkin_history":                     "Istorija promptova",
	"admin_checkin_sla_inactive":                "Unesite datum uključivanja da počnu kalendarske SLA provere.",
	"admin_checkin_save_failed":                 "Čuvanje SLA datuma check-ina nije uspelo",
	...
	"admin_checkin_status_pending":              "Čeka se",
	"admin_save":                                "Sačuvaj",
	"admin_saved":                               "Sačuvano",
	"admin_saving":                              "Čuvanje...",
	...
	"admin_stress_observability_title":          "Pregled stres-opterećenja",
	"admin_stress_observability_desc":           "Read-only operativni prikaz uočenog sustained stress load. Ovo ne uključuje beta i ne menja EnergyBank drain.",
	"admin_stress_observability_loading":        "Učitavam pregled stres-opterećenja...",
	"admin_stress_observability_load_error":     "Greška pri učitavanju pregleda stres-opterećenja.",
	"admin_stress_observability_observed_only":  "Samo posmatranje: stress_drain_enabled=false, effective beta je 0 i stress load se ne primenjuje na EnergyBank drain.",
	"admin_stress_observability_applied":        "Primena aktivna: effective beta nije nula i sustained stress load ulazi u EnergyBank drain.",
	"admin_stress_observability_window":         "Prozor",
	"admin_stress_observability_load_stats":     "Load statistika",
	"admin_stress_observability_flag_counts":    "Broj oznaka",
	"admin_stress_observability_validation":     "Validacija",
	"admin_stress_observability_effective_beta": "Effective beta",
	"admin_stress_observability_no_flags":       "Nema oznaka",
