...
var translationsSr = map[string]string{
	...
	"today_overview":               "Danas",
	"today_recommendation":         "Vaš plan",
	"today_updated_at":             "Ažurirano %s",
	"daily_scores":                 "Najvažnije za danas",
	"sleep_quality":                "Kvalitet sna",
	"sleep_quality_restorative":    "Obnavljajući",
	"sleep_quality_good":           "Dobar",
	"sleep_quality_mixed":          "Mješovit",
	"sleep_quality_poor":           "Nizak",
	"sleep_quality_partial":        "Kvalitet sna se još precizira",
	"sleep_quality_missing":        "Čekamo podatke o prethodnoj noći",
	"sleep_quality_low_confidence": "Niska pouzdanost podataka o fazama",
	"sleep_duration_target":        "%d%% cilja od 8 sati",
	"energy_capacity_short":        "Kapacitet %d",
	"score_waiting":                "Čekamo podatke",
	"score_gauge_aria":             "%s: %s",
	"dashboard_no_data_title":      "Ovdje će se pojaviti vaša slika zdravlja",
	"dashboard_no_data_body":       "Sinhronizujte ili uvezite podatke za dnevnu preporuku, kontekst oporavka i trendove.",
	"dashboard_no_data_action":     "Podesi podatke",
	...
	"readiness_serving_status_fresh":                              "Sveže",
	"readiness_serving_status_missing":                            "Nedostaje ulaz",
	"readiness_serving_status_stale":                              "Zastarelo",
	"readiness_serving_status_data_accruing":                      "Još se skuplja",
	"readiness_serving_status_low_coverage":                       "Niska sigurnost",
	"readiness_serving_status_capped":                             "Korigovano",
	"readiness_serving_desc_fresh":                                "Ključni signali oporavka su sveži i pokriveni.",
	"readiness_serving_desc_missing":                              "Score je ograničen jer danas nedostaje jedan ključni signal.",
	"readiness_serving_desc_stale":                                "Score je ograničen jer je bar jedan ključni signal zastareo.",
	"readiness_serving_desc_data_accruing":                        "Današnji podaci stižu, ali jednom signalu treba više merenja.",
	"readiness_serving_desc_low_coverage":                         "Score je prikazan sa niskom sigurnošću jer jedan ulaz ima slabu pokrivenost ili kvalitet.",
	"readiness_serving_desc_capped":                               "Prikazani score je korigovan zaštitnim pravilom.",
	"readiness_serving_note_missing":                              "Čekamo današnje ključne podatke oporavka.",
	"readiness_serving_note_stale":                                "Deo signala oporavka je zastareo.",
	"readiness_serving_note_data_accruing":                        "Današnji signali se još stabilizuju.",
	"readiness_serving_note_low_coverage":                         "Niska sigurnost: kvalitet ulaza je slab.",
	"readiness_serving_note_capped":                               "Prikazani score je sigurnosno korigovan.",
	"readiness_serving_reason_missing_same_day_evidence":          "Jedan ključni ulaz još nije stigao za danas: HRV, puls u miru ili san. Zato se stariji podaci ne tretiraju kao sveži i prikazani score je ograničen.",
	"readiness_serving_reason_hrv_provisional":                    "HRV danas postoji, ali ima manje od 4 upotrebljiva uzorka. Score ostaje privremen dok ne stigne dovoljno HRV očitavanja.",
	"readiness_serving_reason_hrv_sparse":                         "HRV pokrivenost je danas retka. Score je ograničen jer 1-2 HRV očitavanja mogu previše pomeriti readiness.",
	"readiness_serving_reason_rhr_missing_overnight_hr_available": "Puls u miru danas nedostaje. Noćni puls postoji kao kontekst, ali nije puna zamena.",
	"readiness_serving_reason_sleep_quality_low":                  "San postoji, ali raspodela faza izgleda nepouzdano: previše awake vremena ili premalo deep sna. Zato je readiness manje siguran.",
	"readiness_serving_reason_illness_suspicion_moderate":         "Prisutni su respiratorni, autonomni ili subjektivni signali nalik bolesti. Readiness je oprezno ograničen da ne pokaže visok score.",
	"readiness_serving_reason_illness_suspicion_high":             "Više signala liči na bolest. Readiness je jače ograničen jer telo možda nešto savladava.",
	"readiness_serving_reason_stress_headline":                    "Signali stresa se kose sa visokim readiness score-om, zato prikazani score ostaje oprezan.",
	"readiness_serving_reason_sleep_debt_headline":                "Signali manjka sna se kose sa visokim readiness score-om, zato prikazani score ostaje oprezan.",
	"readiness_serving_core_coverage":                             "Ključna pokrivenost: %d/%d svežih signala.",
	...
	"admin_ai_provider":                         "Provajder",
	"admin_ai_key":                              "API ključ",
	"admin_ai_clear_key":                        "Obriši sačuvani ključ",
	"admin_ai_model":                            "Model",
	"admin_ai_reasoning":                        "Nivo rezonovanja",
	"admin_ai_load_models":                      "Učitaj modele",
	"admin_ai_models_loading":                   "Učitavanje modela…",
	"admin_ai_key_configured":                   "Podešen",
	"admin_ai_key_not_configured":               "Nije podešen",
	"admin_ai_max_tokens":                       "Maks. tokena",
	"admin_ai_save":                             "Sačuvaj",
	"admin_ai_saved":                            "Postavke sačuvane",
	"admin_today_insights_title":                "Pokretanje današnjih uvida",
	...
	"admin_today_insights_b1_gated":             "Isključen — potreban je provereni korpus i evaluacija",
	"admin_today_insights_b1_stale":             "Isključen — provera više ne odgovara aktivnoj AI konfiguraciji",
