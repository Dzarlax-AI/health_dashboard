...
var translationsEn = map[string]string{
	...
	"readiness_serving_desc_low_coverage":                         "The score is shown with low confidence because coverage or quality is weak.",
	...
	"readiness_serving_note_low_coverage":                         "Low-confidence score: coverage is thin.",
	"readiness_serving_note_capped":                               "Displayed score adjusted for safety.",
	"readiness_serving_reason_missing_same_day_evidence":          "Today's HRV, resting heart rate, or sleep input is incomplete.",
	"readiness_serving_reason_hrv_provisional":                    "HRV has too few samples today.",
	"readiness_serving_reason_hrv_sparse":                         "HRV coverage is sparse today.",
	"readiness_serving_reason_rhr_missing_overnight_hr_available": "Resting heart rate is missing; overnight heart rate is available as context only.",
	"readiness_serving_reason_sleep_quality_low":                  "Sleep quality coverage is weak today.",
	"readiness_serving_reason_illness_suspicion_moderate":         "Illness-like signals are present, so the score is conservative.",
	"readiness_serving_reason_illness_suspicion_high":             "Multiple illness-like signals are present, so the score is conservative.",
	"readiness_serving_reason_stress_headline":                    "Stress signals are strong enough to keep the displayed score conservative.",
	"readiness_serving_reason_sleep_debt_headline":                "Sleep-debt signals are strong enough to keep the displayed score conservative.",
