...
var translationsEn = map[string]string{
	...
	"today_recommendation":         "Your plan",
	"today_updated_at":             "Updated %s",
	"daily_scores":                 "Today at a glance",
	"sleep_quality":                "Sleep quality",
	"sleep_quality_restorative":    "Restorative",
	"sleep_quality_good":           "Good",
	"sleep_quality_mixed":          "Mixed",
	"sleep_quality_poor":           "Poor",
	"sleep_quality_partial":        "Quality is still being refined",
	"sleep_quality_missing":        "Waiting for last night's sleep",
	"sleep_quality_low_confidence": "Stage data has low confidence",
	"sleep_duration_target":        "%d%% of the 8-hour duration target",
	"energy_capacity_short":        "Capacity %d",
	"score_waiting":                "Waiting for data",
	"score_gauge_aria":             "%s: %s",
	"dashboard_no_data_title":      "Your health picture will appear here",
	"dashboard_no_data_body":       "Sync or import health data to get a daily recommendation, recovery context, and trends.",
	"dashboard_no_data_action":     "Set up data",
	...
	"readiness_serving_status_fresh":                              "Fresh data",
	"readiness_serving_status_missing":                            "Missing inputs",
	"readiness_serving_status_stale":                              "Stale inputs",
	"readiness_serving_status_data_accruing":                      "Still settling",
	"readiness_serving_status_low_coverage":                       "Low confidence",
	"readiness_serving_status_capped":                             "Adjusted",
	"readiness_serving_desc_fresh":                                "Core recovery signals are fresh and covered.",
	"readiness_serving_desc_missing":                              "The score is limited because a core signal is missing today.",
	"readiness_serving_desc_stale":                                "The score is limited because at least one core signal is stale.",
	"readiness_serving_desc_data_accruing":                        "Today's data is arriving, but one signal needs more samples before confidence is final.",
	"readiness_serving_desc_low_coverage":                         "The score is shown with low confidence because an input has weak coverage or quality.",
	"readiness_serving_desc_capped":                               "The displayed score was adjusted by a safety rule.",
	"readiness_serving_note_missing":                              "Waiting for today's core recovery data.",
	"readiness_serving_note_stale":                                "Some recovery inputs are stale.",
	"readiness_serving_note_data_accruing":                        "Today's signals are still settling.",
	"readiness_serving_note_low_coverage":                         "Low-confidence score: input quality is weak.",
	"readiness_serving_note_capped":                               "Displayed score adjusted for safety.",
	"readiness_serving_reason_missing_same_day_evidence":          "One core input has not arrived for today yet: HRV, resting heart rate, or sleep. The display is capped instead of treating older data as fresh.",
	"readiness_serving_reason_hrv_provisional":                    "HRV is present today, but there are fewer than 4 usable samples. The score stays provisional until enough HRV readings arrive.",
	"readiness_serving_reason_hrv_sparse":                         "HRV coverage is sparse today. The score is capped because one or two HRV readings can swing readiness too much.",
	"readiness_serving_reason_rhr_missing_overnight_hr_available": "Resting heart rate is missing today. Overnight heart rate is available as context, but it is not a full replacement.",
	"readiness_serving_reason_sleep_quality_low":                  "Sleep is present, but the stage breakdown looks unreliable: too much awake time or too little deep sleep. That makes the readiness score less certain.",
	"readiness_serving_reason_illness_suspicion_moderate":         "Illness-like respiratory, autonomic, or subjective signals are present. Readiness is capped conservatively instead of showing a high score.",
	"readiness_serving_reason_illness_suspicion_high":             "Multiple illness-like signals are present. Readiness is capped strongly because the body may be fighting something.",
	"readiness_serving_reason_stress_headline":                    "Stress signals conflict with a high readiness score, so the displayed score stays conservative.",
	"readiness_serving_reason_sleep_debt_headline":                "Sleep-debt signals conflict with a high readiness score, so the displayed score stays conservative.",
	"readiness_serving_core_coverage":                             "Core coverage: %d/%d fresh signals.",
	...
	"illness_signal_respiratory_rate":          "Respiratory rate",
	"illness_signal_blood_oxygen_saturation":   "Blood oxygen",
	"illness_signal_resting_heart_rate":        "Resting HR",
	"illness_signal_heart_rate_variability":    "HRV",
	"illness_signal_wrist_temperature":         "Wrist temperature",
	...
	"admin_today_insights_title":      "Today insights rollout",
	...
	"admin_today_insights_b1_gated":   "Off — requires reviewed corpus and evaluation",
	"admin_today_insights_b1_stale":   "Off — review no longer matches the active AI configuration",
	...
	"admin_stress_observability_title":          "Stress observability",
	"admin_stress_observability_desc":           "Read-only operational view of observed sustained stress load. This does not enable beta or change EnergyBank drain.",
	"admin_stress_observability_loading":        "Loading stress observability...",
	"admin_stress_observability_load_error":     "Failed to load stress observability.",
	"admin_stress_observability_observed_only":  "Observed only: stress_drain_enabled=false, so effective beta is 0 and stress load is not applied to EnergyBank drain.",
	"admin_stress_observability_applied":        "Applied: effective beta is non-zero and sustained stress load contributes to EnergyBank drain.",
	"admin_stress_observability_window":         "Window",
	"admin_stress_observability_load_stats":     "Load stats",
	"admin_stress_observability_flag_counts":    "Flag counts",
	"admin_stress_observability_validation":     "Validation",
	"admin_stress_observability_effective_beta": "Effective beta",
	"admin_stress_observability_no_flags":       "No flags",
