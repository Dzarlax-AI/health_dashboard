...
var translationsRu = map[string]string{
	...
	"today_recommendation":         "Ваш план",
	"today_updated_at":             "Обновлено %s",
	"daily_scores":                 "Главное за сегодня",
	"sleep_quality":                "Качество сна",
	"sleep_quality_restorative":    "Восстанавливающий",
	"sleep_quality_good":           "Хорошее",
	"sleep_quality_mixed":          "Смешанное",
	"sleep_quality_poor":           "Низкое",
	"sleep_quality_partial":        "Качество сна ещё уточняется",
	"sleep_quality_missing":        "Ждём данные о прошедшей ночи",
	"sleep_quality_low_confidence": "Низкая надёжность данных о стадиях",
	"sleep_duration_target":        "%d%% от цели в 8 часов",
	"energy_capacity_short":        "Запас %d",
	"score_waiting":                "Ждём данные",
	"score_gauge_aria":             "%s: %s",
	"dashboard_no_data_title":      "Здесь появится ваша картина здоровья",
	"dashboard_no_data_body":       "Синхронизируйте или импортируйте данные, чтобы получать рекомендацию на день, оценку восстановления и тренды.",
	"dashboard_no_data_action":     "Настроить данные",
	...
	"readiness_serving_status_fresh":                              "Данные свежие",
	"readiness_serving_status_missing":                            "Нет входов",
	"readiness_serving_status_stale":                              "Данные устарели",
	"readiness_serving_status_data_accruing":                      "Ещё собирается",
	"readiness_serving_status_low_coverage":                       "Низкая уверенность",
	"readiness_serving_status_capped":                             "Скорректировано",
	"readiness_serving_desc_fresh":                                "Ключевые сигналы восстановления свежие и покрыты.",
	"readiness_serving_desc_missing":                              "Оценка ограничена, потому что сегодня нет одного из ключевых сигналов.",
	"readiness_serving_desc_stale":                                "Оценка ограничена, потому что один из ключевых сигналов устарел.",
	"readiness_serving_desc_data_accruing":                        "Сегодняшние данные уже поступают, но одному сигналу нужно больше измерений.",
	"readiness_serving_desc_low_coverage":                         "Оценка показана с низкой уверенностью: один из входных сигналов слаб по покрытию или качеству.",
	"readiness_serving_desc_capped":                               "Показанная оценка скорректирована защитным правилом.",
	"readiness_serving_note_missing":                              "Ждём сегодняшние ключевые данные восстановления.",
	"readiness_serving_note_stale":                                "Часть сигналов восстановления устарела.",
	"readiness_serving_note_data_accruing":                        "Сегодняшние сигналы ещё стабилизируются.",
	"readiness_serving_note_low_coverage":                         "Низкая уверенность: качество входных данных слабое.",
	"readiness_serving_note_capped":                               "Показанная оценка скорректирована для безопасности.",
	"readiness_serving_reason_missing_same_day_evidence":          "Один из ключевых входов сегодня ещё не пришёл: HRV, пульс покоя или сон. Поэтому старые данные не считаются свежими, а показанная оценка ограничена.",
	"readiness_serving_reason_hrv_provisional":                    "HRV сегодня есть, но пригодных измерений меньше 4. Оценка остаётся предварительной, пока не придёт достаточно HRV.",
	"readiness_serving_reason_hrv_sparse":                         "Покрытие HRV сегодня редкое. Оценка ограничена, потому что 1-2 измерения HRV могут слишком сильно качнуть readiness.",
	"readiness_serving_reason_rhr_missing_overnight_hr_available": "Сегодня нет пульса покоя. Ночной пульс доступен как контекст, но это не полноценная замена.",
	"readiness_serving_reason_sleep_quality_low":                  "Сон есть, но разбивка по стадиям выглядит ненадёжной: слишком много awake или слишком мало deep. Из-за этого readiness менее точный.",
	"readiness_serving_reason_illness_suspicion_moderate":         "Есть респираторные, автономные или субъективные сигналы, похожие на болезнь. Readiness ограничен осторожно, чтобы не показывать высокий score.",
	"readiness_serving_reason_illness_suspicion_high":             "Несколько сигналов похожи на болезнь. Readiness ограничен сильнее, потому что организм может с чем-то бороться.",
	"readiness_serving_reason_stress_headline":                    "Сигналы стресса конфликтуют с высоким readiness, поэтому показанная оценка остаётся осторожной.",
	"readiness_serving_reason_sleep_debt_headline":                "Сигналы недосыпа конфликтуют с высоким readiness, поэтому показанная оценка остаётся осторожной.",
	"readiness_serving_core_coverage":                             "Ключевое покрытие: %d/%d свежих сигналов.",
	...
	"admin_checkin_coverage_desc":     "Календарный SLA после даты включения, плюс последние утренние Telegram-вопросы и задержка ответа.",
	"admin_checkin_enabled_since":     "Включено с",
	...
	"admin_ai_key":                    "API-ключ",
	"admin_ai_clear_key":              "Удалить сохранённый ключ",
	"admin_ai_model":                  "Модель",
	"admin_ai_reasoning":              "Уровень рассуждений",
	"admin_ai_load_models":            "Загрузить модели",
	"admin_ai_models_loading":         "Загрузка моделей…",
	"admin_ai_key_configured":         "Настроен",
	"admin_ai_key_not_configured":     "Не настроен",
	"admin_ai_max_tokens":             "Макс. токенов",
	"admin_ai_save":                   "Сохранить",
	"admin_ai_saved":                  "Настройки сохранены",
	"admin_today_insights_title":      "Запуск инсайтов на сегодня",
	...
	"admin_today_insights_b1_gated":   "Выключен — нужны проверенные корпус и оценка",
	"admin_today_insights_b1_stale":   "Выключен — проверка не совпадает с текущей AI-конфигурацией",
