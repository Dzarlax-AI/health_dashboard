...
var translationsRu = map[string]string{
	...
	"readiness_serving_desc_low_coverage":                         "Оценка показана с низкой уверенностью: покрытие или качество слабые.",
	...
	"readiness_serving_note_low_coverage":                         "Низкая уверенность: покрытие слабое.",
	"readiness_serving_note_capped":                               "Показанная оценка скорректирована для безопасности.",
	"readiness_serving_reason_missing_same_day_evidence":          "Сегодняшний HRV, пульс покоя или сон неполные.",
	"readiness_serving_reason_hrv_provisional":                    "Сегодня пока мало измерений HRV.",
	"readiness_serving_reason_hrv_sparse":                         "Сегодня покрытие HRV редкое.",
	"readiness_serving_reason_rhr_missing_overnight_hr_available": "Пульса покоя нет; ночной пульс доступен только как контекст.",
	"readiness_serving_reason_sleep_quality_low":                  "Сегодня слабое покрытие качества сна.",
	"readiness_serving_reason_illness_suspicion_moderate":         "Есть сигналы, похожие на болезнь, поэтому оценка осторожная.",
	"readiness_serving_reason_illness_suspicion_high":             "Несколько сигналов похожи на болезнь, поэтому оценка осторожная.",
	"readiness_serving_reason_stress_headline":                    "Сигналы стресса достаточно сильные, поэтому оценка осторожная.",
	"readiness_serving_reason_sleep_debt_headline":                "Сигналы недосыпа достаточно сильные, поэтому оценка осторожная.",
