...
describe("DashboardHero", () => {
  ...
  it("uses a validated overall narrative without replacing the server action", () => {
    ...
    expect(screen.getByText("The current context makes a measured day the more coherent choice.")).toBeInTheDocument();
    expect(screen.queryByText("Keep the effort controlled.")).not.toBeInTheDocument();
    expect(screen.getByText("Measured day")).toBeInTheDocument();
  });
});
