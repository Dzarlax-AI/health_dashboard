  ...
  domains: [
    {
      ...
      insight: { answer_kind: "confirmed_personal", evidence_ids: ["sleep"], fallback: true, meaning: "Sleep is complete.", observation: "You slept well.", state: "insight", title: "Sleep" },
      key: "sleep",
    ...
    },
    {
      ...
      insight: { answer_kind: "provisional_pattern", evidence_ids: ["recovery"], fallback: true, meaning: "Recovery is usable.", observation: "HRV is near usual.", state: "insight", title: "Recovery" },
      key: "recovery",
    ...
    },
    {
      ...
      insight: { answer_kind: "factual_context", evidence_ids: ["energy"], fallback: true, meaning: "Reserve is available.", observation: "Energy is available.", state: "insight", title: "Energy" },
      key: "energy",
