...
|---|---|---|
| EWMA45 baseline (on same split) | 3.0978 | [2.2931, 4.0070] |
| OLS | 4.2342 | [2.9484, 5.5170] |
| Ridge α=0.01 | 4.2281 | — |
| Ridge α=0.1 | 4.1823 | — |
| Ridge α=1.0 | 3.9897 | — |
| Ridge α=10.0 | 3.4447 | — |
| Ridge α=100.0 (best) | 3.0783 | — |
| Ridge α=100.0 (best, with CI) | 3.0783 | [2.2619, 4.0359] |

### Decision

Best linear model on primary test: **Ridge α=100.0** with MAE = 3.0783 bpm, upper CI = 4.0359.
