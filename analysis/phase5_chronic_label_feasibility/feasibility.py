#!/usr/bin/env python3
"""Phase 1 step 2.4 — Chronic Load `chronic_label` classifier feasibility.
...
## Running
    ...
    PSQL=/path/to/psql.exe PYTHONUTF8=1 python \\
        analysis/phase5_chronic_label_feasibility/feasibility.py \\
        > READINESS_REDESIGN_PHASE1_CHRONIC_LABEL_FEASIBILITY.md
...
def load_rows() -> list[Row]:
    """Eligible target + features for chronic_label, test
...
def load_event_base_rate() -> dict[date, float]:
    """event_base_rate naive baseline predictions for chronic_label."""
    sql = f"""
...
def render(primary: dict, sensitivity: dict, n_dropped: int) -> str:
    ...
    out.append("")
    out.append("Auto-generated by `analysis/phase5_chronic_label_feasibility/feasibility.py`. Re-run any time.")
    out.append("")
    ...
    if model_p is None or floor_p is None:
        ...
        out.append(
            ...
            f"different chronic_label criterion, or accept event_base_rate as the deployable layer."
        )
    else:
        out.append(
